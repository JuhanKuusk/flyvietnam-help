...
import { FastTrackBookingForm } from "@/components/ui/fast-track-booking-form";
...
export default function WelcomeConciergePage() {
  const { content, siteConfig } = useSite();
  const { language, setLanguage } = useLanguage();
  const [isModalOpen, setIsModalOpen] = useState(false);

  // Default to English for this page
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex items-center gap-6">
              <a href="#book-online" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 font-semibold">
                Book Now
              </a>
      ...
      {/* Book Online Section - Fast Track Booking Form */}
      <section id="book-online" className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-2xl mx-auto px-4">
          <FastTrackBookingForm />

          {/* Booking Requirements Note */}
          <div className="mt-8 bg-amber-50 dark:bg-amber-900/20 rounded-xl p-6 border border-amber-200 dark:border-amber-700">
            ...
            <ul className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
              <li className="flex items-start gap-2">
                ...
                <span>Please book at least <strong>48 working hours</strong> before your flight</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span>Free cancellation within <strong>24 working hours</strong> of booking</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span>Our team will contact you within 2 hours to confirm</span>
              </li>
            </ul>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              Prefer to book via chat? Contact us directly:
            </p>

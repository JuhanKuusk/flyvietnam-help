    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-4">
            ...
            {isChinaSite && (
              <>
                <div className="bg-white rounded px-2 py-1">
                  <img src="/Alipay-logo.png" alt="Alipay" className="h-5 w-auto" />
                </div>
                <div className="bg-white rounded px-2 py-1">
                  <img src="/WeChat-pay.png" alt="WeChat Pay" className="h-5 w-auto" />
                </div>
                {/* Visa */}
                ...
                {/* UnionPay */}
                <svg className="h-8 w-auto" viewBox="0 0 750 471" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="750" height="471" rx="40" fill="#1A3D6D"/>
                  <path d="M165 100h120c15 0 25 10 20 25l-60 220c-5 15-20 25-35 25H90c-15 0-25-10-20-25l60-220c5-15 20-25 35-25z" fill="#E21836"/>
                  <path d="M270 100h120c15 0 25 10 20 25l-60 220c-5 15-20 25-35 25H195c-15 0-25-10-20-25l60-220c5-15 20-25 35-25z" fill="#00447C"/>
                  <path d="M375 100h120c15 0 25 10 20 25l-60 220c-5 15-20 25-35 25H300c-15 0-25-10-20-25l60-220c5-15 20-25 35-25z" fill="#007B84"/>
                  <text x="375" y="260" textAnchor="middle" fill="white" fontSize="60" fontWeight="bold">银联</text>
                  <text x="375" y="320" textAnchor="middle" fill="white" fontSize="30">UnionPay</text>
                </svg>
              </>
            )}
            {/* Other sites: Visa, Mastercard, American Express, PayPal */}
            {!isChinaSite && (
              <>
                {/* Visa */}
                <svg className="h-8 w-auto" viewBox="0 0 750 471" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className="h-8 w-auto" viewBox="0 0 750 471" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M0 373.641V297.044H82.958L93.543 321.047L104.536 297.044H373.165V311.639C373.165 311.639 385.463 297.044 410.461 297.044H485.336L496.125 321.25L507.118 297.044H591.79V373.641H507.321L497.144 349.231L486.151 373.641H396.871V349.638C396.871 349.638 385.259 373.641 356.888 373.641H0Z" fill="#006FCF"/>
                  <path d="M26.112 310.422H61.896L71.464 333.003L81.235 310.422H117.019V360.063L81.235 310.422H50.023L0 360.063H26.112V310.422Z" fill="white"/>
                  <text x="375" y="245" textAnchor="middle" fill="white" fontSize="80" fontWeight="bold">AMEX</text>
                </svg>
                {/* PayPal */}
                <svg className="h-8 w-auto" viewBox="0 0 750 471" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="sm:hidden flex justify-center items-center gap-3 flex-wrap">
            <span className="text-xs text-gray-500">{t.legal.securePayment}</span>
            {/* Chinese site: Alipay, WeChat Pay, Visa, UnionPay */}
            {isChinaSite && (
              <>
        ...
        <div className="border-t border-gray-700 pt-4 mb-4">
          <div className="text-center mb-3">
            <p className="text-amber-400 font-semibold text-sm mb-2">{t.legal?.officialPartner || "Official Partner: Asia Tour Advisor"}</p>
            <p className="text-gray-400 text-xs">{t.legal?.licenseNumber || "International Tour Operator License No. 01-349/2011/TCDL-GP LHQT"}</p>
          </div>

          {/* Two Office Locations */}
          <div className="grid md:grid-cols-2 gap-4 text-xs text-gray-400">
            {/* Hanoi Office */}
            <div className="text-center md:text-left p-3 bg-gray-800 rounded-lg">
              <p className="font-semibold text-gray-300 mb-1">{t.legal?.hanoiOffice || "Hanoi Office"}</p>
              <p>Tel: <a href="tel:+84904699428" className="hover:text-white transition-colors">+84 904 699 428</a></p>
              <p className="mt-1">{t.legal?.hanoiAddress || "11th Floor, Vinaconex Diamond Tower, 459C Bach Mai Street, Bach Mai Ward, Hanoi, Vietnam"}</p>
            </div>

            {/* Ho Chi Minh City Office */}
            <div className="text-center md:text-left p-3 bg-gray-800 rounded-lg">
              <p className="font-semibold text-gray-300 mb-1">{t.legal?.hcmOffice || "Ho Chi Minh City Office"}</p>
              <p>WhatsApp: <a href="https://wa.me/84705549868" className="hover:text-white transition-colors">+84 705 549 868</a></p>
              <p className="mt-1">{t.legal?.hcmAddress || "Park 7 Building, Floor 38, Vinhomes Central Park, 720A, Binh Thanh District, Ho Chi Minh City, Vietnam"}</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 pt-4 text-center text-xs text-gray-400">
          ...
          <p className="text-gray-500 text-xs">
            © 2026 {content.siteName} - {t.legal?.allRights || "All rights reserved"}
          </p>
        </div>
      </div>
    </footer>

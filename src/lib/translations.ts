...
export const translations = {
  ...
  hero: {
    ...
    oneToTwoHoursDesc: "Your E-Visa will be completed and delivered through WhatsApp and email.",
  ...
  faq: {
    ...
    a5: "We offer a money-back guarantee if your visa is rejected due to our error. We have a high approval rate and will work with you to maximize your chances of success.",
  ...
  processing: {
    ...
    oneToTwo: "1 Hour",
    oneToTwoDesc: "Your E-Visa will be completed and delivered through WhatsApp and email.",
  },
  ...
  applyFaq: {
    ...
    standardNote: "Government processing",
  ...
  legal: {
    ...
    localExpertiseText: "All travel documentation requests are carefully reviewed and processed in Ho Chi Minh City by our local Vietnamese team, ensuring compliance with current regulations and minimizing the risk of delays or rejections. Our local expertise allows us to stay up to date with policy changes and processing requirements.",
    ourMission: "Our Mission",
    ourMissionText: "Our mission is to make your Vietnam travel experience simple, transparent, and stress-free—whether you need urgent travel assistance or professional support with tour bookings and documentation.",
    ...
    governmentFeePurpose: "Purpose:",
    governmentFeePurposeText: "This fee is set by the Vietnamese Government and is the same regardless of where you apply.",
    directOption: "Direct Option:",
    directOptionText: "You may choose to pay only this fee by applying directly through the official government portal:",
    standardProcessingTime: "Standard processing time: 3 business days",
    conciergeServiceFee: "Our Professional Concierge Service Fee",
    conciergeFeeCost: "Varies from $24 USD to $224 USD based on the processing speed you select.",
    conciergeFeePurpose: "This fee covers our comprehensive travel assistance and premium support features.",
    whatIsIncluded: "What is Included:",
    expertDocumentReview: "Expert Document Review",
    expertDocumentReviewText: "Our local experts in Ho Chi Minh City review your application to catch errors before submission.",
    support247: "24/7 Human Support",
    support247Text: "Real-time assistance via WhatsApp at any time, any day.",
    expeditedCoordination: "Expedited Coordination",
    expeditedCoordinationText: "Priority processing for urgent, emergency, or holiday arrivals.",
    realTimeTracking: "Real-Time Tracking",
    realTimeTrackingText: "Instant updates on your application status.",
    moneyBackGuaranteeFees: "Money-Back Guarantee",
    moneyBackGuaranteeFeesText: "A full refund of our service fee if your entry document is not approved.",
    pricingSummary: "Pricing Summary Table (Single Entry)",
    pricingSummaryText: "Our prices include both the government fee AND our service fee. There are no hidden charges.",
    ...
    standardSpeedTime: "2-3 business days",
    expressSpeed: "Express",
    expressSpeedTime: "1-2 days",
    urgentSpeed: "Urgent",
    urgentSpeedTime: "1-4 hours",
    emergencySpeed: "Emergency",
    emergencySpeedTime: "15-30 minutes",
    weekendHolidaySpeed: "Weekend/Holiday",
    weekendHolidaySpeedTime: "Processing on weekends & holidays",
    multipleEntryNote: "Note: For multiple-entry e-Visas, please add $25 USD to the total price to cover the government fee difference.",
    whyTravelersChoose: "Why Travelers Choose Our Service",
    expeditedProcessingBenefit: "Expedited Processing:",
    expeditedProcessingBenefitText: "Get approval in as fast as 30 minutes when you need it urgently",
    support247Benefit: "24/7 Support:",
    support247BenefitText: "Real human support via WhatsApp any time, any day",
    errorPreventionBenefit: "Error Prevention:",
    errorPreventionBenefitText: "We review your application to catch mistakes before submission",
    moneyBackBenefit: "Money-Back Guarantee:",
    moneyBackBenefitText: "Full refund if your visa is not approved",
    transparencyCommitment: "Our Commitment to Transparency",
    transparencyCommitmentText: "We believe in clear, upfront pricing. All fees are displayed before you complete your application. There are no hidden charges, and you will see exactly what you are paying for before submitting payment.",
    questionsAboutFees: "Questions About Our Fees?",
    questionsAboutFeesText: "If you have any questions about our pricing or service fees, please contact us:",
    whatsappSupport: "WhatsApp Support",
    backToHome: "Back to Home",

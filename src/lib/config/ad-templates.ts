...
> = {
  ...
  ZH: {
    URGENT_1H: {
      ...
      descriptions: [
        '在{AIRPORT}遇困？越南签证1小时内批准。本地专家人工处理。',
        '紧急签证服务现已开放。越南办公室营业中。在线申请，顺利登机。',
        '急需越南签证？我们60分钟内处理申请。保证批准。',
        '最快越南签证服务。{PRICE}起。立即申请，今天出发。',
      ],
      finalUrl: `${BASE_URL}/apply?service=urgent-1h&lang=zh`,
      keywords: [
        '紧急越南签证',
        '越南签证1小时',
        '越南签证加急',
    ...
    URGENT_2H: {
      ...
      descriptions: [
        '越南签证2小时批准。行程紧张的完美选择。立即在线申请。',
        '越南签证加急处理。{PRICE}起。快速、可靠、有保障。',
        '需要快速获得签证？2小时处理服务开放中。越南办公室营业。',
        '从{AIRPORT}出发的优先签证服务。仅需2小时批准。',
      ],
      finalUrl: `${BASE_URL}/apply?service=urgent-2h&lang=zh`,
      keywords: [
        '越南签证快速',
        '越南签证2小时',
        '越南签证加急办理',
    ...
    URGENT_4H: {
      ...
      descriptions: [
        '越南签证4小时内办理。立即申请，今天获得批准。',
        '当天越南签证服务。专业处理保障。',
        '今天飞越南？签证4小时内批准。在线申请。',
        '快速处理。4小时。数千旅客的信赖之选。',
      ],
      finalUrl: `${BASE_URL}/apply?service=urgent-4h&lang=zh`,
      keywords: [
        '越南签证当天',
        '越南签证4小时',
        '越南签证今天',
    ...
    '1DAY': {
      ...
      descriptions: [
        '越南签证1个工作日内。专业服务，保证批准。',
        '明天需要签证？今天申请，24小时内获得批准。',
        '快速可靠的签证服务。1天内处理完成。',
        '旅客信赖之选。越南签证仅需1个工作日。',
      ],
      finalUrl: `${BASE_URL}/apply?service=1day&lang=zh`,
      keywords: [
        '越南签证1天',
        '越南签证24小时',
        '越南签证快速办理',
    ...
    '2DAY': {
      ...
      descriptions: [
        '越南签证2个工作日内。价格优惠，专业服务。',
        '在线申请越南签证。2天处理保证。',
        '计划越南之旅？2天内获得签证。简易在线申请。',
        '可靠服务。快速处理，价格优惠。',
      ],
      finalUrl: `${BASE_URL}/apply?service=2day&lang=zh`,
      keywords: [
        '越南签证2天',
        '越南签证在线',
        '越南电子签证',
    ...
    WEEKEND: {
      ...
      descriptions: [
        '这个周末需要越南签证？我们周六周日都工作。',
        '周末签证服务。办公室关闭时的高级处理。',
        '周六遇困？我们周末处理越南签证。',
        '节假日签证紧急情况？我们的团队随时待命。{PRICE}起。',
      ],
      finalUrl: `${BASE_URL}/apply?service=weekend&lang=zh`,
      keywords: [
        '越南签证周末',
        '越南签证周六',
        '越南签证周日',
    ...
    STANDARD: {
      ...
      descriptions: [
        '越南签证简单办理。几分钟在线申请。仅需{PRICE}起。',
        '计划越南之旅？在线签证。快速、简单、优惠。',
        '专业越南签证服务。数千满意旅客。今天申请。',
        '获得越南签证最简单的方式。快速在线申请。',
      ],
      finalUrl: `${BASE_URL}/apply?lang=zh`,
      keywords: [
        '越南签证',
        '越南电子签证',
        '越南签证在线',
